...
const uploadImage = async () => {
    ...
    return(
        <div>
            <button onClick={handleModalOpen} className="text-slate-50 font-medium text-center h-12 bg-transparent p-1 transition-all ease-in hover:text-green-300">+ Create </button>
            {postModal && (
