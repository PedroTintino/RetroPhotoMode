      ...
      <ImageList variant="masonry" cols={3} gap={10}>
        {images.map((image, index) => ( // Corrigindo para passar o índice como segundo parâmetro
          <ImageListItem key={image.id}>
            ...
            <div onClick={() => handleDropdown(index)} className='deleteOption cursor-pointer float-right mb-2 border-[1px] border-slate-50 rounded-[50%] w-8 h-8 flex items-center justify-center'>
              <span>...</span>
            </div>
